...
public class CVImage {
    ...
    public static void addAllImages(JSONObject jo) throws JSONException {
        JSONObject joImg;
        try {
            joImg = jo.getJSONObject("image");
            ...
            Logger.getLogger(CVImage.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static boolean addIssueImg(Issue i, String size) throws JSONException {
        String urlType = null;
        ...
        if (size.contains("medium")) {
            ...
            return false;//TODO: add more later
        }
    ...
    public static boolean addVolumeImg(Volume vol, String size) throws JSONException {
